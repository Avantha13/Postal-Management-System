#include "air_mail.h"
#include "ui_air_mail.h"
#include "home_page.h"
#include "foring_mail.h"
#include<QMessageBox>

air_mail::air_mail(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::air_mail)
{
    ui->setupUi(this);
...
void air_mail::on_pushButton_3_clicked()
{
...
void air_mail::on_pushButton_2_clicked()
{
...
void air_mail::on_lineEdit_5_editingFinished()
{
    QString txt;
...
void air_mail::on_lineEdit_6_editingFinished()
{
    QString txt;
    ...
    {
        ui->lineEdit_8->setText("6500");
    }

}


void air_mail::on_pushButton_clicked()
{
...
void air_mail::on_lineEdit_7_editingFinished()
{
    int v1;
    v1=ui->lineEdit_8->text().toInt();
    int v2;
    v2=ui->lineEdit_7->text().toInt();
